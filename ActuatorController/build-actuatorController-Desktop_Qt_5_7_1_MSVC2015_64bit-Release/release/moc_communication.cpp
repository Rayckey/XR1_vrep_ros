...
#include "../../actuatorController/communication.h"
...
static const uint qt_meta_data_Communication[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::UInt, QMetaType::QByteArray,    3,    1,
...
void Communication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->response((*reinterpret_cast< quint32(*)>(_a[1])),(*reinterpret_cast< const QByteArray(*)>(_a[2]))); break;
        ...
        {
            typedef void (Communication::*_t)(quint32 , const QByteArray );
...
// SIGNAL 0
void Communication::response(quint32 _t1, const QByteArray _t2)
{
